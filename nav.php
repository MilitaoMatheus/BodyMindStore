<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">BodyMindStore</a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="categoria.php?cat=1"> Pré Treino </a></li>
            <li><a href="categoria.php?cat=2"> Whey Protein </a></li>
            <li><a href="categoria.php?cat=3"> Creatina </a></li>
            <li><a href="categoria.php?cat=4"> Suplementação </a></li>
            <li role="separator" class="divider"></li>
            <li><a href="categoria.php?cat=5"> Roupas </a></li>
            <li role="separator" class="divider"></li>
            <li><a href="categoria.php?cat=6"> Garrafas </a></li>
          </ul>
        </li>
      </ul>
      ...
      <li><a href="contato.php">Contato</a></li>
        ...
        <?php } else{
          if($_SESSION['StatusUsu'] == 0){
            $consulta_usuario = $cn->query("select NomeUsuario from tbUsuario where CodUsuario = '$_SESSION[ID]'");
            $exibe_usuario = $consulta_usuario->fetch(PDO::FETCH_ASSOC);
          ?>
          <li><a href="#"><span class="glyphicon glyphicon-user"><?php echo $exibe_usuario['NomeUsuario'];?> </a></span></li>
