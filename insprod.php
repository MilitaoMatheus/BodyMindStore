...
$qtde = $_POST['txtqtde'];
$desc_sinopse = $_POST['txtdescrição'];
$lanc = $_POST['sltlanc'];
...
try {  // try para tentar inserir
	...
	$inserir=$cn->query("INSERT INTO tbProduto(CodCategoria, NomeProduto, CodFabricante, Preco, QtdEstoque, DescInfo, Imagem, Lancamento)
    VALUES ('$cd_cat', '$nome_produto', '$cd_produtora', '$preco', '$qtde', '$desc_sinopse', '$img_nome1', '$lanc')");
