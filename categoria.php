...
<head>
    ...
    <title>BMindStore || Categorias</title>
...
<body>
    ...
    $consulta = $cn->query("select CodProduto, NomeProduto, Preco, Imagem, QtdEstoque from tbProduto where CodCategoria = '$cat'");
    ?>
    ...
    <div class="container-fluid">
      ...
      <!-- Imagens meramente ilustrativas -->
        <div class="col-sm-3">
          ...
          <div><h5><?php  echo number_format($exibe ['Preco'], 2, ',', '.');?></h5></div>
