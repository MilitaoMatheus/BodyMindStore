...
<head>
<meta charset="utf-8">
<title>BMindStore || Inserção de produtos</title>
...
<?php
    ...
    $consultaCategoria = $cn-> query("select * from tbCategoria;");
    $consultaProdutora = $cn-> query("select * from tbFabricante;");
			...
			<div class="col-sm-4 col-sm-offset-4">
				...
				<form method="post" action="insprod.php" name="incluiProd" enctype="multipart/form-data">
					...
					<select class="form-control" name="sltcat">
					  ...
					  <option value="<?php echo $listaCategoria['CodCategoria'];?>"><?php echo $listaCategoria['DescCategoria'];?></option>
                      <?php } ?>				
					</select>
					...
					<select class="form-control" name="sltprodutora">
					  ...
					  <option value="<?php echo $listaProdutora['CodFabricante'];?>"><?php echo $listaProdutora['NomeFabricante'];?></option>
                      <?php } ?>
					</select>
					...
					<label for="txtdescrição">Descrição</label>
						...
						<textarea rows="5" class="form-control" name="txtdescrição"></textarea>
